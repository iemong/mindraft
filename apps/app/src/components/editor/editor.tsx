...
const editorTheme = {
	...
	list: {
		nested: {
			listitem: "pl-5 mt-2 space-y-1 list-decimal list-outside dark:text-white",
		},
		ol: "max-w-md space-y-1 text-gray-500 list-decimal list-outside dark:text-white",
		ul: "max-w-md space-y-1 text-gray-500 list-disc list-outside dark:text-white",
		listitem: "dark:text-white mx-8",
	},
	image: "editor-image",
